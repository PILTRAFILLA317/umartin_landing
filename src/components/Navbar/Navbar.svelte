...
<div class="relative flex w-full flex-row items-center justify-center">
	<div class="fixed inset-x-0 top-10 z-[5000] flex flex-row items-center justify-center gap-5 px-4">
		<div
			class="flex max-w-fit rounded-full border py-2 pr-2 pl-2 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] backdrop-blur-sm border-white/[0.2] bg-black/50"
		>
			<button
		...
		<div
			class="flex items-center justify-center space-x-2 rounded-full border py-2 pr-2 pl-2 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] backdrop-blur-sm border-white/[0.2] bg-black/50"
		>
